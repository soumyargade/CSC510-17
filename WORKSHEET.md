...
| ------------- | ------------  |  ------------
| Saturday, April 9 & Sunday, April 10 | <ul><li>The team reviewed tasks needed for the deploy milestone.</li></ul> | <ul><li>**All**: Each team member will consider how the milestone requirements tranlate for the GitEx bot and begin formulating milestone tasks oriented to the GitEx bot's functionality. </li><li>**Soumya**: Look into creating VCL server reservation. </li></ul>
| Monday, April 11     | <ul><li>**Kim, Dibya, and Alex**: Reviewed requirements needed for acceptance tests and deployment script. </li><li>**Soumya**: Created VCL server reservation.</li><li>**All**: Created kanban board and added tasks. </li></ul> | <ul><li>**Kim & Alex**: Work on acceptance test instructions. </li><li>**Soumya & Dibya**: Work on ansible playbook. </li></ul>
...
| Friday, April 15      | <ul><li>**Kim & Alex**: Completed working on Acceptance test for UC3. </li><li>**Dibya**: Confirmed PAT was sufficient for cloning repo. Added to WORKSHEET.md. </li><li>**Soumya**: Was able to copy tokens from local machine but ran into some issues with environment variables not being set without logging in and out of the remote host.</li></ul> | <ul><li>**Kim**: Add to and proofread documentation. </li><li>**Dibya**: Add to DEPLOY.md about deployment script. </li><li>**Alex**: Ensure task deliverables in WORKSHEET.md accurately reflect progress and work during deploy milestone. </li><li>**Soumya**: Research potentially rebooting remote host to solution for token issue. Record screencast. </li></ul>
| Saturday, April 16      | <ul><li>**Kim**: Proofreading documentation. </li><li>**Dibya**: Added deployment script and final code descriptions to DEPLOY.md. </li><li>**Alex**: Updated WORKSHEET.md with project tasks. </li><li>**Soumya**: Working on screencast. </li></ul> | <ul><li>**All**: Ensure all requirements listed in the DEPLOY.md instructions from the Course repo are met. Proofread and add to documentation as needed. </li><li>**Soumya**: Finish screencast. </li>
| Sunday, April 17      | <ul><li>**All**: Proofread documentation. </li><li>**Soumya**: Created screencast. </li> | The team plans to reflect on this milestone and prepare for the REPORT milestone that will begin immediately.
