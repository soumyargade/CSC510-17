...
| Friday, April 15      | <li>**Kim & Alex**: Completed working on Acceptance test for UC3. </li><li>**Dibya**: Confirmed PAT was sufficient for cloning repo. Added to WORKSHEET.md. </li><li>**Soumya**: Was able to copy tokens from local machine but ran into some issues with environment variables not being set without logging in and out of the remote host. | <li>**Kim**: Add to and proofread documentation. </li><li>**Dibya**: Add to DEPLOY.md about deployment script. </li><li>**Alex**: Ensure task deliverables in WORKSHEET.md accurately reflect progress and work during deploy milestone. </li><li>**Soumya**: Research potentially rebooting remote host to solution for token issue. Record screencast. 
| Saturday, April 16      | | 
| Sunday, April 17      | | 
